...
$sql        = "SELECT * FROM admin_acc WHERE id_admin= '$id_admin'";
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <form class="form" method="post" >
                ...
                <a href="registrasi_administrator.php">
...
if (isset($_POST['simpan'])) {
  ...
  $query = "UPDATE admin_acc SET username = '$username', 
  nama_admin = '$nama_admin' , password = '$password', level = '$level' WHERE id_admin = '$id_admin'";
